...
map1<-tm_shape(mymap_and_info)+tm_polygons("Diabetes Prevalence")+tm_layout(legend.frame="red",main.title="Diabetes Prevalence",title="Mercy Minoo,Enc222_0120_2018",main.title.size=1)
map2<-tm_shape(mymap_and_info)+tm_polygons("Nutrition")+tm_layout(legend.frame="red",main.title="Nutrition",title="Mercy Minoo,ENC222-0120/2018",main.title.size=1)
map3<-tm_shape(mymap_and_info)+tm_polygons("Non-communicable")+tm_layout(legend.frame="red",main.title="Non-communicable",title="Mercy Minoo,ENC222_0120",main.title.size=1)
map4<-tm_shape(mymap_and_info)+tm_polygons("Injuries")+tm_layout(legend.frame="red",main.title="Injuries",title="Mercy Minoo,ENC222-0120/2018",main.title.size=1)
tmap_mode("view")
